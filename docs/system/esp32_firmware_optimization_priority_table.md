...
- Demo APP `WavePendingLifecycleStore` 已完成本地 test/assemble，并已补运行页真机 smoke；Start -> Stop 有 ESP32 `WAVE:START / WAVE:STOP / STOP_SUMMARY` 证据。完整 Demo APP quality baseline 仍需另补信息架构/工具区 marker 才能写成全量通过。
